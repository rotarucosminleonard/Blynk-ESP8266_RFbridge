#define NAMEandVERSION "RF_Bridge_v0.21"
/*
 * Work in progress
...
String targetCode1 = "8D800001"; // Button A
String targetCode2 = "8D800002"; // Button B
String targetCode3 = "8D800003"; // Button C
String targetCode4 = "8D800004"; // Button D
String targetCode5 = "8D800005"; // Flood 1
bool flood1 = 0;
String targetCode6 = "8D800006"; // Flood 2
bool flood2 = 0;
String targetCode7 = "8D800007"; // Flood 3
bool flood3 = 0;
int digit;
...
//   terminal.flush();
  ...
  {
    terminal.println("It Went Wrong. Reset!");
    terminal.flush();
    finishedCode ="";
    receivedString ="";
    i=0;
